...
# Root files
for file in index.html gap-analyse.html portal.html dashboard.html bestellen.html success.html trust.html admin.html faq.html factuur.html robots.txt sitemap.xml .htaccess og-image.svg favicon.svg favicon-16x16.png favicon-32x32.png apple-touch-icon.png android-chrome-192x192.png android-chrome-512x512.png site.webmanifest; do
  if [ -f "$SRC/$file" ]; then
    echo "  Uploading $file..."
